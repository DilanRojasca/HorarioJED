...
<a className="text-[#008499] font-bold border-b-2 border-[#008499] py-5" href="#">Students</a>
<a className="text-slate-500 hover:text-[#008499] transition-colors" href="#">Courses</a>
<a className="text-slate-500 hover:text-[#008499] transition-colors" href="#">Reports</a>
</div>
...
<span>Courses</span>
<span>/</span>
<span className="text-primary">Advanced Algorithms 402</span>
</nav>
<div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
<div>
<h1 className="text-3xl font-black text-on-background leading-tight">Student Roster</h1>
<p className="text-slate-500 mt-1">Viewing all 42 students currently enrolled in this section.</p>
</div>
{/*  Search Bar Section  */}
...
<input 
  ...
  name="id_cedula" 
  placeholder="Search by ID (Cédula)..." 
  type="text"
  value={searchTerm}
