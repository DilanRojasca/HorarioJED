        ...
        <div className="p-6 md:p-10 pt-24 md:pt-10 max-w-7xl mx-auto w-full">
          ...
          <div className="mb-10">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              <div>
                <h1 className="text-3xl font-extrabold text-[#008499] mb-2">Gestión de Cursos</h1>
                <p className="text-slate-500 max-w-lg">Monitoreo de los horarios universitarios.</p>
              </div>
              <div className="flex gap-2">
                <span className="px-3 py-1 bg-[#008499]/10 text-[#008499] rounded-full text-xs font-bold uppercase tracking-wider">{materias.length} Cursos Activos</span>
              </div>
            </div>
          </div>
          {/*  Bento Grid Courses  */}
